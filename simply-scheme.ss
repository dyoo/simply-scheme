...
(provide 
 ...
 (all-from (lib "trace.ss"))
 (rename simply-scheme:* *)
 *the-open-inports*
 *the-open-outports*
 (rename simply-scheme:+ +)
 (rename simply-scheme:- -)
 ...
 (rename simply-scheme:> >)
 (rename simply-scheme:>= >=)
 (rename simply-scheme:abs abs)
 accumulate
 (rename simply-scheme:acos acos)
 align
 appearances
 (rename simply-scheme:asin asin)
 (rename simply-scheme:atan atan)
 before?
 bf
 bl
 butfirst
 butlast
 (rename simply-scheme:ceiling ceiling)
 char->word
 char-rank
 children
 close-all-ports
 (rename simply-scheme:close-input-port close-input-port)
 (rename simply-scheme:close-output-port close-output-port)
 (rename simply-scheme:cos cos)
 count
 datum
 empty?
 (rename simply-scheme:equal? equal?)
 (rename simply-scheme:even? even?)
 every
 (rename simply-scheme:exp exp)
 (rename simply-scheme:expt expt)
 filter
 first
 (rename simply-scheme:floor floor)
 (rename simply-scheme:gcd gcd)
 (rename simply-scheme:integer? integer?)
 item
 keep
 last
 (rename simply-scheme:lcm lcm)
 (rename simply-scheme:list-ref list-ref)
 (rename simply-scheme:log log)
 logoize
 logoize-1
 logoize-2
 make-node
 (rename simply-scheme:make-vector make-vector)
 (rename simply-scheme:max max)
 maybe-num
 member?
 (rename simply-scheme:min min)
 (rename simply-scheme:modulo modulo)
 (rename simply-scheme:negative? negative?)
 (rename simply-scheme:number->string number->string)
 (rename simply-scheme:number? number?)
 (rename simply-scheme:odd? odd?)
 (rename simply-scheme:open-input-file open-input-file)
 (rename simply-scheme:open-output-file open-output-file)
 (rename simply-scheme:positive? positive?)
 (rename simply-scheme:quotient quotient)
 (rename simply-scheme:random random)
 (rename simply-scheme:read-line read-line)
 ...
 show
 show-line
 (rename simply-scheme:sin sin)
 (rename simply-scheme:sqrt sqrt)
 string->word
 strings-are-numbers
 (rename simply-scheme:tan tan)
 (rename simply-scheme:truncate truncate)
 (rename simply-scheme:vector-ref vector-ref)
 (rename simply-scheme:vector-set! vector-set!)
 whoops
 word
 word->string
 word?
 (rename simply-scheme:zero? zero?)
 )
)
